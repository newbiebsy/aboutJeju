			...
			<div class="col-md-9">
				...
				<form name="frm" class="col-12 col-sm-8 col-lg-6 mx-auto" method="post" enctype="multipart/form-data">
					...
					<div class="mb-3 row">
						...
						<div class="col-9">
							<input class="form-control" type="file" id="filename2" name="filename2" onchange="read(this)">
							<span><img src="" alt="" id="preview2" style="width: 40px; height: 30px;" class="my-3" /></span>
						</div>
					</div>
					<div class="d-flex justify-content-center">
						<button type="button" id="cancel" class="btn btn-primary m-2 px-4" role="button">취소</button>
						<button type="button" id="add" class="btn btn-secondary m-2 px-4" role="button">추가</button>
					</div>
				</form>
			</div>
		</div>
