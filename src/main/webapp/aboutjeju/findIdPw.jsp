...
<body class="findIdPw">
	...
	<div class="row mt-5 mb-4">
		...
		<form action="findIdOk.jsp" class="col-10 col-sm-8 col-lg-6 col-xl-4" id="idfrm">
			...
			<div class="mb-3 row">
				...
				<div class="col-6">
					<input type="text" name="inputPhone" class="form-control w-100" id="inputPhone" placeholder="예) 010-0000-0000">
				</div>
	...
	<div class="row mt-5 mb-4">
		<div class="col-1 col-sm-2 col-lg-3 col-xl-4"></div>
		<form action="findPwOk.jsp" class="col-10 col-sm-8 col-lg-6 col-xl-4" id="pwfrm">
			...
			<div class="mb-3 row">
				<label for="inputQuestion" class="col-form-label col-3">PW 찾기 질문</label>
				<div class="col-9">
			...
			<div class="mb-3 row">
				<label for="inputAnswer" class="col-form-label col-3">PW 찾기 답</label>
				<div class="col-9">
					<input type="text" name="inputAnswer" class="form-control" id="inputAnswer">
				</div>
			</div>
