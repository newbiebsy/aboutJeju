...
<div class="col-md-3 d-none d-md-block sidebar">
	...
	<nav class="nav flex-column h-75">
		<a class="nav-link text-white ps-0 <%=cp == null ? "selected" : ""%>"
			...
			href="hostBookingCheck.jsp?cno=<%=ovo.getOno()%>&cp=1">예약 관리</a>

		<div class="nav-link text-white mt-2 ps-0">
			숙소 관리 <a class="nav-link text-white mt-2" href="productManage.jsp">숙소 정보 관리</a> <a
				class="nav-link text-white" href="roomManage.jsp">방 정보 관리</a>
		</div>
