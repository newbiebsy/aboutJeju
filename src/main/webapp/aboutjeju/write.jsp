...
<body>
	...
	<div class="row write">
		...
		<form action="writeOk.jsp" class="col-10 col-sm-8 col-lg-6 col-xl-4"
			id="writefrm">
			<h4 class="mt-5 mb-4 fw-bold text-center">이용 후기</h4>
			<div class="card p-4 mb-1">
				<div class="row">
					<div class="col-4">
						<img src="<%=avo.getAimage()%>" class="rounded-start w-100 h-100"
							alt="<%=avo.getAname()%>">
					</div>
					<div class="col-8">
						<div class="card-body">
			...
			<div class="card p-4 mb-4">
				...
				<div class="mb-3 row">
					...
					<div class="col-10">
						<textarea class="form-control" name="inputContents"
							id="inputContents" rows="10"></textarea>
					</div>
				</div>
				<div class="mt-2 text-center">
					<a class="btn btn-outline-primary shadow-sm mx-3 px-3 submit"
						role="button"><i class="bi bi-check-lg"></i> 작성하기</a>
				</div>
			</div>
		</form>
		<div class="col-1 col-sm-2 col-lg-3 col-xl-4"></div>
