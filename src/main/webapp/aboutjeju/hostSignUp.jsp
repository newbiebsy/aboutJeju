...
<body class="hostSignUp signUp">
	...
	<div class="row my-5">
		...
		<form action="hostSignUpOk.jsp" class="col-10 col-sm-8 col-lg-6 col-xl-4" id="signUpfrm">
			<h4 class="mb-4 fw-bold text-center">회원가입</h4>
			<div class="mb-3 row">
				<label for="inputId" class="col-form-label col-4">아이디</label>
				<div class="col-8">
					<input type="text" class="form-control" name="inputId" id="inputId" placeholder="아이디 길이 5~20자">
			...
			<div class="mb-3 row">
				...
				<div class="col-8">
					<input type="number" class="form-control" name="inputOno" id="inputOno" placeholder="- 제외한 숫자만 입력">
			...
			<div class="mb-3 row">
				...
				<div class="col-5">
					<input type="number" name="inputPhone" class="form-control w-100" id="inputPhone" placeholder="- 제외한 숫자만 입력">
				</div>
			...
			<div class="mt-4 text-center">
				<a href="login.jsp" class="btn btn-secondary m-3 px-4" role="button"><i class="bi bi-x-lg"></i> 취소</a> 
				<a class="btn btn-primary m-3 px-4 submit"><i class="bi bi-check-lg"></i> 확인</a>
			</div>
		</form>
		<div class="col-1 col-sm-2 col-lg-3 col-xl-4"></div>
	</div>
